...
def cast_lightning(*args, **kwargs):
	...
	if target:
		results.append({"consumed": True, "target": target, "message": Message("A lightning bolt strikes the {0} with a loud thunder, dealing {1} damage.".format(target.name, damage))})
