...
class Entity:
	...
	def move_astar(self, target, entities, game_map):
		...
		# Check if the path exists, and in this case, also if the path is shorter than 25 tiles
		...
		# It makes sense to keep path size relatively low to keep monsters from running around the map if
